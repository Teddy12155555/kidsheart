  ...
  render() {
    return (
      <div className="lesson">
        {/* <img
          src="/assets/Image/Lesson/full.png"
          style={{
            opacity: "0.2",
            position: "absolute",
          }}
        ...
        <div className="container">
          ...
          <div className="title_black">那些孩子需要感覺統合課程訓練?</div>
          <div className="content_text_black">
            {[
          ...
          <div className="content_container_lesson">
            ...
            <img className="img" src="/assets/Image/Lesson/lesson_1.png"></img>
          </div>
          ...
          <div className="content_img full">
            <img src="/assets/Image/Lesson/lesson_2.png"></img>
            <span className="slogan_1">及早治療　發展健全</span>
          </div>
          ...
          <div className="content_img duo neighbor">
            <img
          ...
          <div className="blank" style={{ height: "100px" }}></div>
          ...
          <div className="content_img neighbor centerize">
